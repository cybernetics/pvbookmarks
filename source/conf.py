# -*- coding: utf-8 -*-
#
# Software engineering documentation build configuration file, created by
# sphinx-quickstart on Sun Dec 19 10:18:31 2010.
#
...
#import cloud_sptheme as csp
# il faut copier C:\Python27\Lib\site-packages\cloud_sptheme-1.2-py2.7.egg\cloud_sptheme\themes dans _themes
...
#Dash docset dashbuilder
dash_name = 'pvbookmarks'
# dash_icon_file = '_static/pvergain.png'
...
latex_documents = [
  ('index', 'Softwareengineering.tex', u'Development tools',
   u'Patrick Vergain', 'manual'),
]
...
man_pages = [
    ('index', 'softwareengineering', u'Development tools',
     [u'Patrick Vergain'], 1)
]
...
texinfo_documents = [
  ('index', 'Development tools', u'Development tools', u'Patrick Vergain',
   'Softwareengineering', 'One line description of project.', 'Miscellaneous'),
]
...
epub_title = u'Development tools'
epub_author = u'Patrick Vergain'
epub_publisher = u'Patrick Vergain'
epub_copyright = u'2010-2013, Patrick Vergain'
