...
field equals to 7. "Man, too much work for a
`programmer <http://en.wikipedia.org/wiki/Laziness>`_", you might say.
Yes, I am one two, that's why I have implemented some
