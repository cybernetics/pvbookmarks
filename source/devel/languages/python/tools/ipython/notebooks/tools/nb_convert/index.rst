...
.. index::
   pair: IPython; Notebook Convert
   pair: Data format; Notebook Convert
   ! Notebook Convert    
...
=================================================
IPython Notebook convert (nbconvert)
=================================================

.. seealso::

   - http://ipython.org/ipython-doc/stable/interactive/nbconvert.html
